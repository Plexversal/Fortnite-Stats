...
module.exports.run = async (client, message, args, settings) => {
    ...
    if(!args[0]) {
        ...
        return message.reply(`\`Error:\` No EPIC account is associated with your account. You can link your username using \`${dbdata.prefix}set <your epic username>\`. To view an epic account, use \`${dbdata.prefix}${this.config.name} <epicname>\`.`)
